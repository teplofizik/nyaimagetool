...
{
    class TFtpGet : ScriptStepGenerator
    {

        public TFtpGet() : base("tftpget")
        {
        ...
        {
            return new TTFtpGetScriptStep(Args.RawArgs[0], Args.RawArgs[1], Args.RawArgs[2]);
        }

        public class TTFtpGetScriptStep : ScriptStep
        {
            ...
            public TTFtpGetScriptStep(string Filename, string Server, string ServerFN) : base("tftp")
            {
            ...
            public override ScriptStepResult Exec(ImageProcessor Processor)
            {
                ...
                var transfer = client.Download(ServerFN);
